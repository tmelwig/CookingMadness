...
export const LikeToggle = ({ recetteID }: LikeToggleProps) => {
  ...
  useEffect(() => {
    async function getLikedState() {
      ...
      const isFavorite = favorites.some((id) => id === recetteID);
      ...
      >
        {isLiked ? (
          <svg
            ...
            className="x1lliihq x1n2onr6 xxk16z8 text-custom-dark-orange"
            fill="currentColor"
            height="24"
            role="img"
            viewBox="0 0 48 48"
          ...
          <svg
            aria-label="J’aime"
            className="x1lliihq x1n2onr6 xyb1xck text-gray-700"
            fill="currentColor"
            height="24"
            role="img"
            viewBox="0 0 24 24"
